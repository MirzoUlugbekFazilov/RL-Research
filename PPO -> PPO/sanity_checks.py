...
def _same_hparams():
    ...
    sibling = None
    for cand in (ROOT.parent / "GFlowNet to PPO (2 corrupted)",
                 ROOT.parent / "PPO to GFlowNet (2 corrupted)",
                 ROOT.parent / "gflownet to ppo",
                 ROOT.parent / "ppo to gflownet",
                 ROOT.parent / "RL+PPO", ROOT.parent / "RL+gflowne"):
