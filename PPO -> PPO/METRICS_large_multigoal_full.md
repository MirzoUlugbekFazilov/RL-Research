# Study C_full — metrics

**PPO on corrupted -> PPO fine-tuned on original (full model)**
...
| ppo_finetune_full_original | 0.778 ± 0.138  [0.726, 0.829] | 157.8 ± 44.1  [141.4, 174.3] | 78.8 ± 18.2  [72.0, 85.6] | 0.849 ± 0.062  [0.825, 0.872] |
...
|---|---|---|---|---|---|---|---|
| Success rate | 0.778 | 0.827 | -0.049 | -0.49 | 0.0646 | 0.0646 | 0.1504 |
| Mean return | 157.8 | 185.7 | -27.9 | -0.84 | 0.0022 | 0.0067 | 0.0002 |
| Steps to goal (successful eps) | 78.8 | 68.6 | 10.1 | 0.74 | 0.0066 | 0.0132 | 0.0253 |
| Path efficiency L*/L | 0.849 | 0.899 | -0.050 | -1.05 | 0.0002 | 0.0008 | 0.0000 |
...
|---|---|---|---|---|---|
| Success rate | 0.778 | 0.826 | -0.049 | -0.47 | 0.0779 |
| Mean return | 157.2 | 185.7 | -28.5 | -0.85 | 0.0024 |
| Steps to goal (successful eps) | 79.1 | 68.7 | 10.5 | 0.75 | 0.0066 |
| Path efficiency L*/L | 0.848 | 0.900 | -0.052 | -1.07 | 0.0002 |
...
|---|---|---|---|---|
| 0.25 | finetune | 30/30 | 0 | 39,000 |
| 0.25 | scratch | 30/30 | 15,000 | 10,500 |
| 0.50 | finetune | 29/30 | 105,000 | 113,793 |
| 0.50 | scratch | 30/30 | 15,000 | 31,500 |
| 0.80 | finetune | 25/30 | 225,000 | 223,800 |
...
|---|---|---|---|---|---|
| seed_1000 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_123 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2000 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2001 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2002 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2003 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2004 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2005 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2006 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2007 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2008 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2009 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2010 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2011 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2012 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2013 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2014 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2015 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2016 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2017 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2018 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2019 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2020 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2021 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2022 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2023 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_2024 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_42 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_456 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |
| seed_789 | ppo → ppo | 12 | 0.00e+00 | 1.000 | yes |

Everything transfers here: actor, critic and Adam moments, by `PPO.load`. This
is ordinary PPO fine-tuning, and it is the arm the cross-algorithm studies could
not run. Its gap over the actor-only arm is the price of the value function a
GFlowNet has no way to provide. The scratch control still starts from a random
critic, so this arm — unlike every other in the three studies — holds an
advantage over its control beyond initialisation, and its contrast should be
